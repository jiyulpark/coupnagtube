...
// 빌드 시 환경 변수가 없어도 빌드는 성공하도록 더미 값 사용
// 런타임에 환경 변수가 없으면 에러가 발생하므로 Vercel에서 환경 변수를 설정해야 합니다
const finalUrl = supabaseUrl || 'https://placeholder.supabase.co';
const finalKey = supabaseKey || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBsYWNlaG9sZGVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NDUxOTIwMDAsImV4cCI6MTk2MDc2ODAwMH0.placeholder';
